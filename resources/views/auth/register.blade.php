...
<div class="main_card" style="text-align: @lang('trans.align')">
  <h1><a href="https://pinglu.in/"><div class="welcome-brand-img"></div></a></h1>
  ...
  <div class="form-group">
    <div class="form-check">
      ...
      <label style="@if (App::isLocale('ar')) padding:0px 15px; @endif" class="custom-control-label" for="agree_signup">
          I am at least 17 years old and have read and accepted the terms and conditions. <a href="https://pinglu.in/space/terms.html">@lang('trans.terms_of_service')</a> @lang('trans.and') <a href="https://pinglu.in/space/terms.html">@lang('trans.privacy_policy')</a>.
      </label>
      @if ($errors->has('terms'))
   ...
   <button  type="submit" onclick="javascript:window.open('{{ url()->previous() }}');" class="btn btn-dark">@lang('trans.register')</button>
...
<br>
 <center><a href="/login/facebook"  class="fb-login-button" data-size="large" >Join us with Facebook</a></center>
