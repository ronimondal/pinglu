...
<br>
 <center><a href="/login/facebook"  class="fb-login-button" data-size="large" >Log in with Facebook</a></center>
  
  <hr>
  @lang('trans.dont_have_an_account') <a href="{{ route('register') }}">Join us!</a> @lang('trans.now').
</div>
