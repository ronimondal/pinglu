...
<textarea @if(App::isLocale('ar')) style="direction: inherit;" @endif dir="auto" name="feedback_content" class="send_feedback_field" maxlength="500" placeholder="Send anonymous messages, advice, criticism or anything on earth you wanted to tell me!"></textarea>
...
@endif
@guest
<strong><a href="{{ route('register') }}" class="send_feedback_btn"> Wanna Confess ?</a></strong>
@endif
...
@guest
<br>
<center><a href="{{ route('register') }}" class="login-btn"><strong>Join and Fun !</strong></a></center>
<br>
@endif
@endif
</div>
